...
export class ProductComponent implements OnInit, OnChanges {
  ...
  editProduct(idProduct: any) {
    // @ts-ignore
    document.getElementById("formEditProduct").hidden = false;
    this.productService.getProductById(idProduct).subscribe(product => this.formProduct.patchValue(product))
  }

  viewDetail(idProduct: any) {
    this.productService.getProductById(idProduct).subscribe(data => this.products = [data])
  }
